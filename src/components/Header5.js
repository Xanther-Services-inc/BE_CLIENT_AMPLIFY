...
//import './theme-color/color-5.css'
const URL = require("./constants");

const Header5 = () => {
	//let location = useLocation();
	// if(location.pathname === "/home-five"){
	// 	require('./theme-color/color-5.css');
	// }
	...
	return (
		<>
			<Loader />
			<header id="site-header" className="header header-5">
								...
								<nav className="navbar navbar-expand-lg">
									<a className="navbar-brand logo" href="/">
										<img
											...
											src={`${URL.img_url}${dataHeader.data.home[4].logo}`}
											alt=""
										/>
										<img 
											id="logo-img" 
											className="img-center sticky-logo" 
											src={`${URL.img_url}${dataHeader.data.home[4].logosticky}`} 
											alt=""
										/>		
