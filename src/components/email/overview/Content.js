...
const Content = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async() =>{
      const {data} = await Axios.get(`${process.env.REACT_APP_API}/api/v1/user/issues`,{ headers: {"Authorization" : `Bearer ${userInfo.token}`} });
      setState({
        ...state,
        issues: data,
      })
        ...
        title: (
          ...
          <EmailHeader>
            <Heading as="h5">
              ...
              <Link to={`/issues/single/${id}`}><strong>{title}</strong></Link>
            </Heading>
        ...
        email: (
          ...
          <EmailAuthor>
            <Heading as="h5">
              ...
              <Link to={`/issues/single/${id}`}><strong>{user_email}</strong></Link>
            </Heading>
        ...
        emp: (
          ...
          <EmailAuthor>
            <Heading as="h5">
              ...
              <Link to={`/issues/single/${id}`}><strong>{employee}</strong></Link>
            </Heading>
        ...
        id: (
          ...
          <EmailHeader>
            <Heading as="h5">
              ...
              <Link to={`/issues/single/${id}`}><strong>{id}</strong></Link>
            </Heading>
