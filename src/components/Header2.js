...
//import './theme-color/color-2.css'
const URL = require("./constants");

const Header2 = () => {
	//let location = useLocation();
	// if(location.pathname === "/home-two"){
	// 	require('./theme-color/color-2.css');
	// }
								...
								<nav className="navbar navbar-expand-lg">
									<a className="navbar-brand logo" href="/">
										<img
											...
											src={`${URL.img_url}${dataHeader.data.home[1].logo}`}
											alt=""
										/>
										<img 
											id="logo-img" 
											className="img-center sticky-logo" 
											src={`${URL.img_url}${dataHeader.data.home[1].logosticky}`} 
											alt=""
										/>		
