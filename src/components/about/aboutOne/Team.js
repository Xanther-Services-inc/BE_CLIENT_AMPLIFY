...
const Team = () => {
	return (
		<section className="bg-effect right pos-r o-hidden">
				...
				<div className="row">
					<div className="col-lg-8 col-md-12">
						<div className="section-title">
							...
							<h6>{dataTeam.data.about[0].team.title}</h6>
							<h2 className="title">
								{dataTeam.data.about[0].team.sub_title}
							</h2>
						</div>
					</div>
				</div>
				...
				<div className="row">
					<div className="col-xl-10 col-lg-11 col-md-10 ml-auto">
						<div
							...
							data-autoplay="true"
						>
							{dataTeam.data.about[0].team.members.map(
								(member, index) => (
			...
			<div className="container">
				<div className="row">
					{dataTeam.data.about[0].team.logos.map((logo, index) => (
